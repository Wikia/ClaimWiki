...
class TemplateClaimEmails {
	...
	public function claimStatusNotice($status, $emailExtra) {
		...
		$userName = $emailExtra['claim']->getUser()->getName();
		...
		if ($status == "pending") {
			...
			$HTML .= "Dear {$userName},<br/><br/>
					...
					If you are not already on it, we would also like to invite you to join us on the official Fandom and Gamepedia Discord. Discord is a messaging platform for teams, and joining our Discord is a great way for you, as an active editor, to keep in touch with our staff as well as other active editors and admins. You will need a Discord account. Here is the invitation link: http://discord.gg/Fandom<br/><br/>
